...
namespace CarsDB
{
    public partial class PackegeCreate : Form
    {
        ...
        {
            int kod;
            string namePackege = textBox2.Text;
            ...
            try
            {
                ...
                string query = "INSERT INTO Комплектация (КодКомплектации, Комплектация) VALUES (" + kod + ",'" + namePackege + "')";
